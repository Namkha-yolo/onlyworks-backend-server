-- ========================================
-- FIXED ONLYWORKS DATABASE SCHEMA
-- Fixed duplicate column issue
-- ========================================
...
CREATE TABLE IF NOT EXISTS analysis_reports (
    ...
    focus_analysis TEXT,
    total_screenshots_analyzed INTEGER DEFAULT 0,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS batch_reports (
    ...
    processed_screenshots INTEGER NOT NULL,
...
-- Session Details View (with reports) - FIXED column names
...
SELECT 'SUCCESS: Fixed OnlyWorks database schema created successfully!' as result,
       'Schema includes: Users, Teams, Goals, Sessions, Screenshots, AI Analysis, Settings, Analytics' as features,
       'Ready for production use with both frontend and backend - duplicate column issue FIXED' as status;